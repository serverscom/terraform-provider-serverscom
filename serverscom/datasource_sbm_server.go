...
func dataSourceServerscomSBMServer() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceServerscomSBMServerRead,
...
func dataSourceServerscomSBMServerRead(d *schema.ResourceData, meta any) error {
